...
class Responder_OptionsManager {
    ...
    public function settingsPage() {
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'responder'); ?></h2>
            

            <h2 class="semi-title"><?php echo $this->getPluginDisplayName(); echo ' '; _e('Login', 'responder'); ?></h2>
            <h2 class="semi-title"><?php echo $this->getPluginDisplayName(); echo ' '; _e('Registration', 'responder'); ?></h2>
...
?>
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'responder') ?>"/>
                </p></td></tr>
                </tbody></table>

                
                <div id="container">
                <iframe id='res_reg' src="https://cp.responder.co.il/trial.php"></iframe>
                </div>
            </form>
